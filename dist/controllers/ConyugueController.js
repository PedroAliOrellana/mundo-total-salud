...
var Conyugue = require('../models/Conyugue');
    ...
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            params = new Conyugue(req.body);
            _context.next = 3;
            return Conyugue.create(params);
    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return Conyugue.find();

          case 2:
            conyugue = _context2.sent;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            id = req.params.id;
            _context3.next = 3;
            return Conyugue.findOne({
              cedula_afiliado: id
            });

          case 3:
            conyugue = _context3.sent;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            id = req.params.id;
            _context4.next = 3;
            return Conyugue.findById(id);

          case 3:
            conyugue = _context4.sent;
            req.conyugue = conyugue;
            next();
