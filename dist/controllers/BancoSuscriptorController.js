...
var bancoSuscriptor = require('../models/BancoSuscriptor');
    ...
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            banco = new bancoSuscriptor(req.body);
            _context.next = 3;
            return bancoSuscriptor.create(banco);
    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return bancoSuscriptor.find().populate('Suscriptor');

          case 2:
            banco = _context2.sent;
            res.status(200).json(banco);
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            id = req.params.id;
            _context4.next = 3;
            return bancoSuscriptor.findById(id);

          case 3:
            banco = _context4.sent;
            req.banco = banco;
            next();
